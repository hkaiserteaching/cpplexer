...
namespace hpx {
    ...
    public:
        ...
        static constexpr void advance(Iterator& it, Distance n) noexcept(
            noexcept(
    ...
    namespace detail {
        ...
        struct arrow_dispatch    // proxy references
        {
            ...
            static constexpr type call(Reference const& x) noexcept
            {
                return type(x);
            }
        };
        ...
        struct arrow_dispatch<T&>    // "real" references
        {
            ...
            static constexpr type call(T& x) noexcept
            {
        ...
        public:
            ...
            Derived& operator++() noexcept(noexcept(
        ...
        public:
            ...
            Derived operator--(int) noexcept(noexcept(
                iterator_core_access::decrement(std::declval<Derived&>())))
            {
        ...
        public:
            explicit constexpr operator_brackets_proxy(
        ...
        public:
            ...
            constexpr typename operator_brackets_result<Derived, T>::type
    ...
    namespace detail {
        ...
        struct postfix_increment_result<Iterator, Value, Reference,
            std::enable_if_t<
                has_category_v<Iterator, std::input_iterator_tag> &&
...
#define HPX_UTIL_ITERATOR_FACADE_INTEROP_HEAD(prefix, op, result_type)         \
    ...
    prefix typename hpx::detail::enable_operator_equal_interoperable<Derived1, \
...
#define HPX_UTIL_ITERATOR_FACADE_INTEROP_HEAD_EX(                              \
    ...
    template <typename Derived1, typename T1, typename Category1,              \
        ...
        typename Derived2, typename T2, typename Category2,                    \
        typename Reference2, typename Distance2, typename Pointer2>            \
    prefix typename hpx::detail::enable_operator_interoperable_ex<Derived1,    \
