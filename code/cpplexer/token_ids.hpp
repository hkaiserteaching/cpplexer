...
#define BASEID_FROM_TOKEN(tok) ((tok) & ~ExtTokenTypeMask)
    ...
    enum token_id : std::uint32_t
    {
        ...
        T_ANDASSIGN_ALT =
            TOKEN_FROM_ID(259, OperatorTokenType | AltExtTokenType),
        T_OR = TOKEN_FROM_ID(260, OperatorTokenType),
        T_OR_ALT = TOKEN_FROM_ID(260, OperatorTokenType | AltExtTokenType),
        T_OR_TRIGRAPH =
            TOKEN_FROM_ID(260, OperatorTokenType | TriGraphTokenType),
        T_ORASSIGN = TOKEN_FROM_ID(261, OperatorTokenType),
        T_ORASSIGN_ALT =
            TOKEN_FROM_ID(261, OperatorTokenType | AltExtTokenType),
        T_ORASSIGN_TRIGRAPH =
        ...
        T_XOR_TRIGRAPH =
            TOKEN_FROM_ID(262, OperatorTokenType | TriGraphTokenType),
        T_XORASSIGN = TOKEN_FROM_ID(263, OperatorTokenType),
        T_XORASSIGN_ALT =
            TOKEN_FROM_ID(263, OperatorTokenType | AltExtTokenType),
        ...
        T_LEFTBRACKET_ALT =
            TOKEN_FROM_ID(278, OperatorTokenType | AltTokenType),
        ...
        T_NOTEQUAL_ALT =
            TOKEN_FROM_ID(285, OperatorTokenType | AltExtTokenType),
        T_OROR = TOKEN_FROM_ID(286, OperatorTokenType),
        T_OROR_ALT = TOKEN_FROM_ID(286, OperatorTokenType | AltExtTokenType),
        T_OROR_TRIGRAPH =
            TOKEN_FROM_ID(286, OperatorTokenType | TriGraphTokenType),
        ...
        T_RIGHTBRACKET_ALT =
            TOKEN_FROM_ID(295, OperatorTokenType | AltTokenType),
        ...
        T_FIXEDPOINTLIT = TOKEN_FROM_ID(
            386, FloatingLiteralTokenType | AltTokenType),    // IDL specific
        ...
        T_POUND_POUND_ALT =
            TOKEN_FROM_ID(395, OperatorTokenType | AltTokenType),
        ...
        T_ANY_TRIGRAPH =
            TOKEN_FROM_ID(397, UnknownTokenType | TriGraphTokenType),
        ...
        T_EXTPARAMETERBASE =
            TOKEN_FROM_ID(T_LAST_TOKEN + 4, ExtParameterTokenType),
        T_OPTPARAMETERBASE =
            TOKEN_FROM_ID(T_LAST_TOKEN + 4, OptParameterTokenType)
    };

    ///////////////////////////////////////////////////////////////////////////////
    //  token_category and token_id may be used together
    constexpr token_id operator&(token_id a, token_category b) noexcept
    {
    ...
    constexpr bool operator==(token_category a, token_id b) noexcept
    {
...
#undef TOKEN_FROM_ID
#define TOKEN_FROM_ID(id, cat) wave::token_id((id) | (cat))

#undef ID_FROM_TOKEN
#define ID_FROM_TOKEN(tok)                                                     \
    wave::token_id((tok) & ~(wave::TokenTypeMask | wave::PPTokenFlag)) /**/

#undef BASEID_FROM_TOKEN
#define BASEID_FROM_TOKEN(tok)                                                 \
    wave::token_id((tok) & ~(wave::ExtTokenTypeMask | wave::PPTokenFlag)) /**/
#define BASE_TOKEN(tok) wave::token_id((tok) &wave::MainTokenMask)        /**/
#define CATEGORY_FROM_TOKEN(tok) ((tok) &wave::TokenTypeMask)
#define EXTCATEGORY_FROM_TOKEN(tok) ((tok) &wave::ExtTokenTypeMask)
...
#define IS_EXTCATEGORY(tok, cat)                                               \
    ...
    constexpr bool is_pp_token(wave::token_id id) noexcept
    {
        return (id & wave::PPTokenFlag) ? true : false;
    }

    template <typename TokenT>
    constexpr bool is_pp_token(TokenT const& tok) noexcept
    {
        return is_pp_token(static_cast<wave::token_id>(tok));
    }

    ///////////////////////////////////////////////////////////////////////////////
    //  return a token name

    WAVE_STRINGTYPE get_token_name(token_id tokid);
